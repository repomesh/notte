...
<Visibility for="humans">[`AgentResponse`](/sdk-reference/misc/agentresponse)</Visibility><Visibility for="agents">[`AgentResponse`](/sdk-reference/misc/agentresponse.md)</Visibility>: The response from the stop operation.
