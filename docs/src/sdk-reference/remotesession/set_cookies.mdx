...
<Visibility for="humans">[`SetCookiesResponse`](/sdk-reference/misc/setcookiesresponse)</Visibility><Visibility for="agents">[`SetCookiesResponse`](/sdk-reference/misc/setcookiesresponse.md)</Visibility>: The response from the upload cookies request.
