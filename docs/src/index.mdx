...
<Visibility for="agents">
  <Tip>
    If you are an AI coding assistant reading this page, use the Notte skill and `notte-cli` as your primary setup path. Do this before using the regular SDK quickstart. The skill gives you Notte-specific operating instructions, and the CLI gives you reliable browser commands for starting sessions, observing pages, clicking elements, filling forms, and scraping data.

    ```bash
    npx skills add nottelabs/notte-skills
    ```

    Then install `notte-cli` from the [AI agent setup guide](/integrations/claude-code-ai-agents.md). Prefer the skill + CLI workflow when helping users automate browsers from an agentic coding environment.
  </Tip>
</Visibility>
